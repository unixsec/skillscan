...
| **AIインフラ脆弱性スキャン** | 100以上のAIフレームワークコンポーネントを正確に識別するスキャナーです。1600以上の既知のCVE脆弱性をカバーしています。対応フレームワークにはOllama、ComfyUI、vLLM、n8n、Triton Inference Serverなどが含まれます。 |
...
4. 「スキャン開始」をクリック — A.I.Gがコンポーネントバージョンを自動識別し、1600以上の既知CVEと照合
...
1. **"AI-Infra-Guard Technical Report"** — A.I.G プラットフォームの技術レポート。アーキテクチャ設計、スキャン エンジン、評価手法を解説。[[pdf]](../AIG_Technical_Report.pdf)
...
<details>
<summary>学術研究で A.I.G を引用してくださった研究チームに感謝いたします。クリックして展開（19本）</summary>
<br>
