...
4. 点击「开始扫描」— A.I.G 会自动识别组件版本，匹配 1600+ 已知 CVE
...
1. **"AI-Infra-Guard Technical Report"** — A.I.G 平台技术报告，涵盖架构设计、扫描引擎与评估方法。[[pdf]](../AIG_Technical_Report.pdf)
...
<details>
<summary>感谢在学术研究中引用 A.I.G 的团队，点击展开（19 篇论文）</summary>
<br>
